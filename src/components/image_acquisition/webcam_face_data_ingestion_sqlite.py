...
class DataIngestionConfig:
    raw_face_data_path:str = os.path.join('artifacts', 'webcam_raw_face_data')
...
class DataIngestion:
    def __init__(self):
        ...
        self.ingestion_config.frames_per_acquisition = 30 * 10  # 300 frames in each acquisition file
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            # Cpture the Webcam video file with the specified FPS
